...
async function main() {
  ...
  const tickerItems = [
    { label: "EVENT", date: "JUNE 2026", text: "Global Youth Leadership Summit 2026 registration is now officially open.", color: "blue" },
    { label: "EXPANSION", date: "MAY 2026", text: "Meru expands footprint to South America with new regional offices in Bogota.", color: "emerald" },
    { label: "MILESTONE", date: "APRIL 2026", text: "Corporate Excellence Program achieves milestone of training 50,000+ professionals.", color: "purple" },
    { label: "PARTNERS", date: "MARCH 2026", text: "Partnered with 12 new European academic organizations for global exchanges.", color: "amber" },
  ];
  ...
  console.log(`✓ ${pages.length} pages initialized`);
  ...
  if (historySlotsCount === 0) {
    ...
    console.log(`✓ ${historySlotsData.length} history slots seeded`);
  }
